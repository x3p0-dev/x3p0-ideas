...
// Houses all of our block style variations as objects and assigned to their
// respective blocks. The key for the variation is its `name`, and the value is
// its label.
const BLOCK_STYLES = {
	'core/button': {
	...
	'core/pullquote': {
		...
		'clip-text':   __( 'Clip Text', 'x3p0-ideas' ),
		'hand-drawn':  __( 'Hand Drawn', 'x3p0-ideas' ),
		'mark-double': __( 'Mark: Double', 'x3p0-ideas' ),
	...
	'core/separator': {
		...
		'hand-drawn':   __( 'Hand Drawn',    'x3p0-ideas' ),
		'hatched':      __( 'Hatched',       'x3p0-ideas' ),
		'scallop-down': __( 'Scallop: Down', 'x3p0-ideas' ),
		'scallop-up':   __( 'Scallop: Up',   'x3p0-ideas' )
	},
	'core/social-links': {
		'hand-drawn': __( 'Hand Drawn', 'x3p0-ideas' ),
