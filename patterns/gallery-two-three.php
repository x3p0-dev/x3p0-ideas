...
?>
<!-- wp:group {"align":"wide","style":{"spacing":{"blockGap":"var:preset|spacing|base"}},"layout":{"type":"default"}} -->
<div class="wp-block-group alignwide">

	<!-- wp:gallery {"columns":2,"linkTo":"none","sizeSlug":"x3p0-16x9-lg"} -->
	<figure class="wp-block-gallery has-nested-images columns-2 is-cropped">

		<?php foreach ( range( 1, 2 ) as $number ) : ?>

			<!-- wp:image {"sizeSlug":"x3p0-16x9-lg","linkDestination":"none"} -->
	...
	<!-- wp:gallery {"columns":3,"linkTo":"none","sizeSlug":"x3p0-16x9-lg"} -->
