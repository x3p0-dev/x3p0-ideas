...
<main class="wp-block-group is-style-site-content">
	...
	<article class="wp-block-group" style="padding-top:0px;padding-bottom:var(--wp--preset--spacing--70)">
		...
		<header class="wp-block-cover is-light has-custom-content-position is-position-bottom-center" style="padding-top:var(--wp--preset--spacing--120);padding-right:0;padding-bottom:0;padding-left:0;min-height:36rem">
		...
		<!-- wp:group {
			"align":"full",
			"gradient":"180-deg-base-transparent",
			"layout":{"type":"default"}
		} -->
		<div class="wp-block-group alignfull has-180-deg-base-transparent-gradient-background has-background">
