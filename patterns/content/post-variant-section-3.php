...
/**
 * Title: Post Content: Section 3
 * Slug: x3p0-ideas/content-post-variant-section-3
 * Inserter: no
 */
...
<main class="wp-block-group is-style-site-content">
	...
	<article class="wp-block-group" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)">
		...
		<header class="wp-block-group" style="padding-right:var(--wp--preset--spacing--70);padding-left:var(--wp--preset--spacing--70)">
			...
			<!-- wp:group {
				"className":"has-bounds-border is-style-section-3",
				"style":{
					"spacing":{
						"padding":{
			...
			<div class="wp-block-group has-bounds-border is-style-section-3" style="padding-top:var(--wp--preset--spacing--90);padding-right:var(--wp--preset--spacing--90);padding-bottom:var(--wp--preset--spacing--90);padding-left:var(--wp--preset--spacing--90)">
