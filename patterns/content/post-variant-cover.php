...
/**
 * Title: Post Content: Cover
 * Slug: x3p0-ideas/content-post-variant-cover
 * Inserter: no
 */
...
<main class="wp-block-group is-style-site-content">
	...
	<article class="wp-block-group" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)">
		...
		<header class="wp-block-group" style="padding-right:var(--wp--preset--spacing--70);padding-left:var(--wp--preset--spacing--70)">
			...
			<div class="wp-block-cover has-bounds-border is-style-cover-dark has-custom-content-position is-position-bottom-left" style="padding-top:var(--wp--preset--spacing--90);padding-right:var(--wp--preset--spacing--90);padding-bottom:var(--wp--preset--spacing--90);padding-left:var(--wp--preset--spacing--90)">
				...
				<div class="wp-block-cover__inner-container">
					...
					<!-- wp:group {"metadata":{"name":"<?= esc_attr__('Post Header', 'x3p0-ideas') ?>"},"style":{"spacing":{"blockGap":"var:preset|spacing|40"},"dimensions":{"minHeight":""}},"layout":{"type":"default"}} -->
