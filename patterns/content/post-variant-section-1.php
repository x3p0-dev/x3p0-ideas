...
/**
 * Title: Post Content: Section 1
 * Slug: x3p0-ideas/content-post-variant-section-1
 * Inserter: no
 */
...
<main class="wp-block-group is-style-site-content">
	...
	<article class="wp-block-group" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)">
		...
		<header class="wp-block-group" style="padding-right:var(--wp--preset--spacing--70);padding-left:var(--wp--preset--spacing--70)">
			...
			<div class="wp-block-group has-global-border is-style-section-1" style="padding-top:var(--wp--preset--spacing--90);padding-right:var(--wp--preset--spacing--90);padding-bottom:var(--wp--preset--spacing--90);padding-left:var(--wp--preset--spacing--90)">
