...
/**
 * Title: Portfolio Project Content
 * Slug: x3p0-ideas/content-portfolio-project
 * Inserter: no
 */
...
<main class="wp-block-group is-style-site-content">
	...
	<article class="wp-block-group" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)">
		...
		<footer class="wp-block-group is-style-meta">
			<!-- wp:post-terms {"term":"portfolio_category","className":"is-style-icon"} /-->
			<!-- wp:post-terms {"term":"portfolio_tag","className":"is-style-icon"} /-->
		</footer>
		<!-- /wp:group -->
