...
/**
 * Title: Post Content: Cover In Cover
 * Slug: x3p0-ideas/content-post-variant-cover-in-cover
 * Inserter: no
 */
...
<main class="wp-block-group is-style-site-content">
	...
	<article class="wp-block-group" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)">
		...
		<header class="wp-block-group" style="padding-right:var(--wp--preset--spacing--70);padding-left:var(--wp--preset--spacing--70)">
			...
			<div class="wp-block-cover is-style-global-border" style="padding-top:var(--wp--preset--spacing--70);padding-right:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70);padding-left:var(--wp--preset--spacing--70)">
