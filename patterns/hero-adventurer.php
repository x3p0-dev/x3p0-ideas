...
<div class="wp-block-cover alignfull has-parallax has-custom-content-position is-position-bottom-left pattern-hero-adventurer" style="padding-top:var(--theme-spacing--plus-5);padding-right:var(--wp--preset--spacing--plus-3);padding-bottom:var(--theme-spacing--plus-5);padding-left:var(--wp--preset--spacing--plus-3);min-height:90vh">
	...
	<div role="img" class="wp-block-cover__image-background wp-image-2268 has-parallax" style="background-position:50% 50%;background-image:url(<?= esc_url( $hero_image ) ?>)"></div>

	<div class="wp-block-cover__inner-container">
		<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|minus-1"}},"layout":{"type":"constrained","justifyContent":"left"}} -->
		<div class="wp-block-group">
			...
			<div class="wp-block-buttons">
				...
				<div class="wp-block-button is-style-outline">
					<a class="wp-block-button__link wp-element-button">More About Me →</a>
				</div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
