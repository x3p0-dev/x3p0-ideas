...
<div class="wp-block-query alignfull">
	...
	<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"right":"var:preset|spacing|80","left":"var:preset|spacing|80","top":"var:preset|spacing|80"}}},"layout":{"type":"default"}} -->
	<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--80)">
		...
		<!-- wp:post-template {"align":"full"} -->
			...
			<div class="wp-block-group">
				...
				<!-- wp:columns {"verticalAlignment":"top","align":"wide","style":{"spacing":{"blockGap":{"top":"var:preset|spacing|120","left":"var:preset|spacing|120"}}}} -->
				<div class="wp-block-columns alignwide are-vertically-aligned-top">
					...
					<div class="wp-block-column is-vertically-aligned-top">
						...
						<div class="wp-block-group">
							<!-- wp:post-title {"isLink":true,"style":{"typography":{"fontStyle":"normal","fontWeight":"500"},"spacing":{"margin":{"bottom":"var:preset|spacing|20"}}},"fontSize":"2-xl"} /-->

							<!-- wp:columns {"style":{"border":{"top":{"color":"var:preset|color|contrast","style":"solid","width":"1px"},"right":{},"bottom":{},"left":{}},"spacing":{"blockGap":{"top":"var:preset|spacing|40","left":"var:preset|spacing|40"}}}} -->
							<div class="wp-block-columns" style="border-top-color:var(--wp--preset--color--contrast);border-top-style:solid;border-top-width:1px">
								...
								<div class="wp-block-column has-white-background-color has-background">
									...
									<div class="wp-block-group">
										<!-- wp:post-excerpt {"moreText":"Continue reading →","showMoreOnNewLine":false,"excerptLength":18,"style":{"spacing":{"margin":{"top":"var:preset|spacing|20"}}},"fontSize":"xl"} /-->
									</div>
									<!-- /wp:group -->
								...
								<div class="wp-block-column has-white-background-color has-background" style="flex-basis:7rem">
									<!-- wp:post-date {"textAlign":"center","format":"M j","style":{"spacing":{"padding":{"top":"var:preset|spacing|10","right":"var:preset|spacing|10","bottom":"var:preset|spacing|10","left":"var:preset|spacing|10"}}},"backgroundColor":"contrast","textColor":"base","fontSize":"md"} /-->
								</div>
								<!-- /wp:column -->
