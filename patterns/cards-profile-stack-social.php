...
<section class="wp-block-group alignfull has-90-deg-primary-base-transparent-gradient-background has-background" style="padding-top:var(--wp--preset--spacing--plus-4);padding-right:var(--wp--preset--spacing--plus-3);padding-bottom:var(--wp--preset--spacing--plus-4);padding-left:var(--wp--preset--spacing--plus-3)">
	...
	<div class="wp-block-group alignwide">
		...
		<?php foreach (range(1, 6) as $card) : ?>
			...
			<div class="wp-block-group is-style-card has-neutral-muted-color has-180-deg-transparent-base-gradient-background has-text-color has-background has-sm-font-size" style="border-top-color:var(--wp--preset--color--primary-contrast);border-top-width:0.25rem;padding-top:var(--wp--preset--spacing--plus-3)">
				...
				<div class="wp-block-group has-neutral-base-background-color has-background" style="padding-top:var(--wp--preset--spacing--base);padding-right:var(--wp--preset--spacing--plus-3);padding-bottom:var(--wp--preset--spacing--base);padding-left:var(--wp--preset--spacing--plus-3);font-style:normal;font-weight:600">

					<!-- wp:social-links {"iconColor":"neutral-muted","iconColorValue":"#715036","size":"has-large-icon-size","className":"is-style-logos-only","layout":{"type":"flex","justifyContent":"center"}} -->
